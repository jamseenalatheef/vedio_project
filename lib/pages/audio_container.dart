...
import 'package:vedio_project/pages/seek_bar.dart';
...
class _AudioContainerState extends State<AudioContainer>
  ...
  Widget build(BuildContext context) {
    log("aaaiididd==" + _audioId);
    _player.setUrl(_audioTitle);
    return Padding(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return SeekBar(
                                  ...
                                  onChangeEnd: (newPosition) {
                                    _player
                                        .seek(newPosition ?? const Duration());
                                  },
                                );
                              },
                            );
